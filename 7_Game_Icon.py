...
pygame.display.set_icon(pygame.image.load(os.path.join("Images/Dino/DinoDead.png")))
black = (0, 0, 0)
...
BIRD = [
    pygame.image.load(os.path.join("Images/Bird", "Bird1.png")),
...
def menu(death_count):
    ...
    while run:
        ...
        if death_count == 0:
            ...
            score = font.render(f"Your Score: {str(points)}", True, black)
